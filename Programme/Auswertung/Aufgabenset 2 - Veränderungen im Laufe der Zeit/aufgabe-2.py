...
temp1_zm = np.mean(temp_zm[date1_index:date1_index+12,:,:], axis=0)
...
for q in range(1, 129):
  date2 = str(1970+q) + "01"
  date2_index = 240 + 12*q
  print('date2: ',times[date2_index])
  temp2_zm = np.mean(temp_zm[date2_index:date2_index+12,:,:], axis=0)
  title='Temperature '+date2
  title_file='jahres_plots/temp_'+date2+'.png'
  steps=10
  ...
  title_file='differenzen/temp_'+date2+'-'+date1+'.png'
